  ...
  return (
    <main className="min-h-screen text-[#24150d]">
      ...
      <section className="relative min-h-[400px] ">
        ...
        <div className="relative mx-auto flex min-h-[400px] max-w-4exl items-center px-3 pb-10 pt-20 lg:px-4">
          <div className="max-w-3xl">
            <p className="mb-2 text-sm font-bold uppercase tracking-[0.25em] text-[#ffd229]">
              Join Our Growing Family
            </p>

            <h1 className="text-3xl font-black leading-[0.98] text-white sm:text-6xl lg:text-4xl">
            ...
            <div className="my-7 h-1 w-24 rounded-full bg-[#ffd229]" />
            ...
            <div className="mt-4 flex flex-wrap gap-4">
              <a
                href="#franchise-form"
                className="group inline-flex items-center gap-3 rounded-full bg-[#ffd229] px-3 py-3.5 font-bold text-[#24150d] transition hover:-translate-y-1 hover:bg-[#ffe06a]"
              >
                Explore Franchise
                <ArrowRight
                  size={18}
              ...
              <a
                href="#process"
                className="inline-flex items-center gap-3 rounded-full border border-white/40 px-7 py-3.5 font-semibold text-white transition hover:border-[#ffd229] hover:text-[#ffd229]"
              >
                How It Works
              </a>
            </div>
        ...
        {/* Decorative text */}
        <div className="absolute right-[0%] top-[23%]  lg:block">
          <p className="font-serif text-l font-bold italic text-[#ffd229]">
            "A cup of tea,a beautiful evening,<br/>
            A little warmth in every sip.  
          </p>
          <p className="font-serif text-l font-bold italic text-[#ffd229]">
            Good conversations,cherished moments,<br/>
            And tea that makes every moment special."
          </p>
          <div className="mt-2 text-center text-3xl text-[#ffd229]">💛✨☕</div>
        </div>
      </section>
      ...
      >
        <div className="mx-auto max-w-5xl">
          <div className="grid overflow-hidden rounded-[24px] bg-[#2b150a] shadow-2xl lg:grid-cols-[0.9fr_1.3fr]">
            {/* Left side */}
            <div className="relative flex item-center justify-center overflow-hidden">
              <Image
                src="/corner-cafe.png"
                alt="ChaiChowkCafe"
                width={600}
            ...
            {/* Form */}
            <div className="bg-[#fffaf0] p-3 sm:p-4 lg:p-4">
              <div className="mb-2">
                ...
                <div className="grid gap-2 sm:grid-cols-2">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className=" rounded-lg border border-[#d8cdbd] bg-white px-2 py-1.5 outline-none transition placeholder:text-black/35 focus:border-[#d8a914] focus:ring-2 focus:ring-[#ffd229]/20"
                    />
                  </div>
