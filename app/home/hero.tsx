            ...
            <section className="relative min-h-screen w-full overflow-hidden">
                ...
                <div className="relative z-10 flex min-h-screen items-center justify-center px-6 py-20 text-center text-white">
                    <div className="max-w-4xl">
                        ...
                        data-aos="fade-up"
                        data-aos-delay="200"
                        className="mx-auto mb-5 max-w-2xl text-sm leading-3 text-white/90 sm:text-base">
                        ...
                        data-aos="fade-up"
                        data-aos-delay="300"
                        className="mx-auto mb-4 max-w-2xl text-sm leading-3 text-white/80 sm:text-base">
                        ...
                        data-aos="fade-up"
                        data-aos-delay="500"
                        className="mx-auto mb-7 max-w-2xl text-sm leading-3 text-white/80 sm:text-base">
                        ...
                        data-aos="zoom-in"
                        data-aos-delay="700"
                        className="mb-10 text-lg font-bold tracking-wide text-orange-300 sm:text-xl">
